...
HADOOP_PREFIX = "/usr/local/Hadoop2.0/%s" % HADOOP_PACKAGE
...
ENVIRONMENT_FILE = "/users/shiweid/.profile"
#ENVIRONMENT_FILE_NOTAUTOLOADED = True
...
HADOOP_TEMP = "/l0/hadoop/tmp"
HDFS_DATA_DIR = "/l0/hdfs/datanode"
HDFS_NAME_DIR = "/l0/hdfs/namenode"
