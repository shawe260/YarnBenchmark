...
def startParser():
    parser = argparse.ArgumentParser(description = "This script is for benchmarking heterogenous jobs on Yarn. See more configuration in directory ./conf and defaults.py")
    ...
    parser.add_argument('-tr', '--trace', action = 'store', dest = 'traceFile', help = "Only used for TraceExecutor. Default trace file (in /trace) will be used, if not specified ")
